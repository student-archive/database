...
values ((select "id" from "attachment_type" order by random() limit 1),
        ...
        'E60F4D895ADAC6961E1C95560F174394238D6A01'),
       ((select "id" from "attachment_type" order by random() limit 1),
        ...
        'E60F4D895ADAC6961E1C95560F174394238D6A02'),
       ((select "id" from "attachment_type" order by random() limit 1),
        'https://vk.com/s/v1/doc/u1xvnpF85jfbtPP9ZuIAgBiaZg0zoZHDTVWYLDF-RUK-Z5QC2hs',
        'E60F4D895ADAC6961E1C95560F174394238D6A03'),
       ((select "id" from "attachment_type" order by random() limit 1),
...
values ((select "id" from "employee_position" order by random() limit 1),
        (select "id" from "employee" order by random() limit 1)),
       ((select "id" from "employee_position" order by random() limit 1),
        (select "id" from "employee" order by random() limit 1)),
       ((select "id" from "employee_position" order by random() limit 1),
        (select "id" from "employee" order by random() limit 1)),
       ((select "id" from "employee_position" order by random() limit 1),
